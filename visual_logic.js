...
createCSSRule('.v3d-annotation', "position: absolute; width: 30px; height: 30px; background-image: url(\'dot.gif\'); background-position: center; padding: 0px; border: none; background-repeat: no-repeat; background-size: 100%;", false, '');
